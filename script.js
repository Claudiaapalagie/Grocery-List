...
function addQuantityToShoppingList(clickedBtn, shoppingDiv) {
    if (clickedBtn.classList[0] === 'add-button') {
        ...
        if (ingredientQuantity > 0) {
            ...
            createButtonElement('button', awesomeClass = '<i class="fas fa-check"></i>', 'check-button', shoppingDiv)
            createButtonElement('button', awesomeClass = '<i class="fas fa-trash"></i>', 'trash-button', shoppingDiv)
...
function createIngredientsDiv() {
    ...
    createButtonElement('button', awesomeClass = '<i class="fas fa-plus-square"></i>', 'add-button', ingredientsDiv)
    createButtonElement('button', awesomeClass = '<i class="fas fa-trash"></i>', 'trash-button', ingredientsDiv)
